...
import time
pre_path = "C:/Users/Bon/Desktop/pre.txt"
post_path = "C:/Users/Bon/Desktop/post.txt"
with open(pre_path, 'w') as fw:
...
with open(post_path, 'w') as fw:
    fw.write(str(time.time()))

# import IN_API_SERVER
# r = IN_API_SERVER.run_server()

# server_script_path = 'D:\\DEV\\Github\\IN_PYTHON_API_Release\\src\\script\\run_api_server.bat'
# p = subprocess.Popen(server_script_path, shell=True, creationflags=subprocess.CREATE_NEW_PROCESS_GROUP)
