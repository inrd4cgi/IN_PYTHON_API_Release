...
namespace INS {
	...
	struct FolderVO {
		...
		typedef QMap<qint32,QString> map_tmp_t;

		Gen4Py(map_tmp_t,folders);
		QMap<qint32, FileVO> files;//子文件信息
		typedef QMap<qint32,FileVO*> map_tmp_tt;

		Gen4Py(map_tmp_tt,files);
	...
	struct FileVO {
		...
		typedef QMap<qint32,FileVersionVO*> map_tmp_ttt;

		Gen4Py(map_tmp_ttt,fileVersions);
	...
	********************************************************************/
	struct Person {
		...
		Gen4Py(QList<IdName*>,subordinates);
	...
	********************************************************************/
	...
	struct ProjectData {
		...
		typedef QMap<qint32,qint32> map_tmp_tttt;

		Gen4Py(map_tmp_tttt,assetData);
		QMap<qint32, qint32> shotData;//镜头数据
		typedef QMap<qint32,qint32> map_tmp_ttttt;

		Gen4Py(map_tmp_ttttt,shotData);
...
#define IN_PROJECT_BASE_PROPERTY projectId,projectName,issueDate,dueDate,actual_start_time,actual_end_time,\
	...
	struct INPipelineStep {
		...
		Gen4Py(QList<INQWorkPath*>,outputFileList);
        QList<PipeLineStepApproval> approvalList;//审批员列表

		Gen4Py(QList<PipeLineStepApproval*>,approvalList);
	...
	struct INQWorkFlowDetail {
		...
		Gen4Py(QList<qint32>,parentStepIds);
		...
		Gen4Py(QList<WorkFlowDetlFile*>,wfdFileList);
	...
	struct INQWorkFlowVO {
		...
		Gen4Py(QList<INQWorkFlowDetail*>,workFlowDetails);
        IdName creator;
    ...
    struct INTask : public INTaskBaseObj {
		...
		Gen4Py(QList<TaskApproval*>,approvalList);
	...
	struct INTaskComment {
		...
		Gen4Py(QList<qint32>,audioIds);
        QList<qint32> videoIds;

		Gen4Py(QList<qint32>,videoIds);
        QList<qint32> pixmapIds;

		Gen4Py(QList<qint32>,pixmapIds);
	...
	struct INAsset : public INProjectBaseObj {
		...
		Gen4Py(QList<INTask*>,createtasklist);
        IdName creator;
	...
	struct TagResourceVO {
		...
		Gen4Py(QList<TagInfoVO*>,tagInfos);
	...
	struct VariantVO {
		...
		Gen4Py(QList<FileTaskVO*>,taskFiles);
	...
	struct AffectedObjectInfoVO {
		...
		typedef QMap<qint32,QString> map_tmp_tttttt;

		Gen4Py(map_tmp_tttttt,affectedAssignees);
		QMap<qint32, QString> affectedAssets;//受影响的资产
		typedef QMap<qint32,QString> map_tmp_ttttttt;

		Gen4Py(map_tmp_ttttttt,affectedAssets);
		QMap<qint32, QString> affectedShots;//受影响的镜头
		typedef QMap<qint32,QString> map_tmp_tttttttt;

		Gen4Py(map_tmp_tttttttt,affectedShots);
		QMap<qint32, QString> affectedProjects;//受影响的项目
		typedef QMap<qint32,QString> map_tmp_ttttttttt;

		Gen4Py(map_tmp_ttttttttt,affectedProjects);

		QMap<qint32, AffectedTaskInfo> affectedTaskInfos;//受影响的taskd的列表，key为taskId
		typedef QMap<qint32,AffectedTaskInfo*> map_tmp_tttttttttt;

		Gen4Py(map_tmp_tttttttttt,affectedTaskInfos);
	...
	struct TaskFileVO {
		...
		Gen4Py(QList<SequenceFileSetVO*>,sequenceFiles);

		QMap<qint32, Task> fileTaskMap;//文件文件对应的输出任务列表 key:文件id,value:任务信息
		typedef QMap<qint32,Task*> map_tmp_ttttttttttt;

		Gen4Py(map_tmp_ttttttttttt,fileTaskMap);
	...
	struct PanelReviewVO {
		...
		Gen4Py(QList<IdName*>,participents);
	...
	public:
		...
		Gen4Py(QList<INQHolidayDetail*>,detailList);
    ...
    struct TaskDurationProgress
    {
		...
		Gen4Py(QList<TaskStatusItem*>,taskStatusList);
        QList<TaskStage>        taskStageList;

		Gen4Py(QList<TaskStage*>,taskStageList);
    ...
    struct TaskWorkflowDetail
    {
		...
		Gen4Py(QList<qint32>,parentTaskIdList);
        qint32 status = 0; // 任务状态
        qint32 taskType = 0; // 节点类型 0-普通任务节点 1-容器
        qint32 containerId = 0;
        QList<TaskLinkFile> taskFileList;

		Gen4Py(QList<TaskLinkFile*>,taskFileList);
        qint32 operation = 0; // 用户操作 -1 - 删除 0-默认 1-新增
    ...
    struct TaskWorkflow
    {
		...
		Gen4Py(QList<TaskWorkflowDetail*>,taskList);
