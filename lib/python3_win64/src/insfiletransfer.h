...
namespace INS
{
	...
	public:
		...
		INSFileTransfer(const INFileBase& file, const QString& rootDir, const QString& absolutePath = QString());
		~INSFileTransfer() override;

		INFileBase m_file;	//客户端输入的文件结构体对象。包含客户端输入的文件数据。
		...
		INQRespondInfo m_responFromAppSever;	//应用服务器返回的业务结果。
	...
	class INSDRIVER_EXPORT INSUpLoad : public INSFileTransfer
	{
		Q_OBJECT;
	public:
		INSUpLoad(const INFileBase& file, const QString& rootDir, const QString& absolutePath = QString());
	...
	class INSDRIVER_EXPORT INSDownLoad : public INSFileTransfer
	{
		Q_OBJECT;
	public:
		INSDownLoad(const INFileBase& file, const QString&rootDir);
	...
	class INSDRIVER_EXPORT INSCheckIn : public INSUpLoad
	{
		Q_OBJECT;
	public:
		INSCheckIn(const INFileBase& file, const QString& rootDir, const QString& absolutePath = QString());
	...
	class INSDRIVER_EXPORT INSCheckOut : public INSDownLoad
	{
		Q_OBJECT;
	public:
		INSCheckOut(const INFileBase& file, const QString& rootDir);
	...
	class INSDRIVER_EXPORT INSUploadTinyFile : public INSFileTransfer
	{
		Q_OBJECT;
	public:
		INSUploadTinyFile(const INFileBase& file, const QString& rootDir, const QString& absolutePath = QString());
	...
	class INSDRIVER_EXPORT INSUpLoadUserAvatar : public INSUploadTinyFile
	{
		Q_OBJECT
	public:
		INSUpLoadUserAvatar(const INFileBase & file, const QString & absolutePath);
		~INSUpLoadUserAvatar() {};
	...
	class INSDRIVER_EXPORT INSUploadLibraryFile : public INSUpLoad
	{
		Q_OBJECT;
	public:
		INSUploadLibraryFile(const INFileBase& fileBase, const QString& absolutePath);
	};
