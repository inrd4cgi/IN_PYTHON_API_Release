...
namespace INS
{
	...
	struct INFolderBase {
		...
		typedef QMap<qint32,INFileBase*> map_tmp_tt;
	...
	struct INFileBase {
		...
		Gen4Py(QList<INFileHistory*>,version_list);
	...
	********************************************************************/
	struct PersonRelationInfo {
		...
		Gen4Py(QList<tag_CIdName*>,subordinates);
	...
	********************************************************************/
	struct TeamInfomation {
		...
		Gen4Py(QList<tag_CIdName*>,crews);
	...
	********************************************************************/
	...
	struct INFileStructTemplate {
		...
		Gen4Py(QList<INFileStruct*>,fileStructDetail);
		//对象序列化
	...
	struct ProjectData {
		...
		typedef QMap<qint32,qint32> map_tmp_ttt;

		Gen4Py(map_tmp_ttt,assetData);
		QMap<qint32, qint32> shotData;//镜头数据
		typedef QMap<qint32,qint32> map_tmp_tttt;

		Gen4Py(map_tmp_tttt,shotData);
	...
	struct INQProjectVO :public INProjectBaseObj {
		...
		Gen4Py(QList<INPipelineStep*>,pipelineSteps);
	...
	struct INQServerInfo {
		...
		Gen4Py(QList<INQDiskInfo*>,diskInfos);
...
#define DataStreamOut(classType) friend QDataStream& operator <<(QDataStream& out, const classType& obj)
	...
	struct TaskFileVO {
		...
		typedef QMap<qint32,QString> map_tmp_tttttttttt;

		Gen4Py(map_tmp_tttttttttt,folders);
