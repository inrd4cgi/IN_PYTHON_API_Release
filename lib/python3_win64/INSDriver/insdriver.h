...
namespace INS_INTERFACE
{
	...
	INSDRIVER_EXPORT INQRespondInfo GetAllHolidays(QList<INQHolidayTemplate>& holidays);

	INSDRIVER_EXPORT INQRespondInfo GetAllHolidaysInNewlyYear(QList<INQHolidayTemplate> &holidays);
