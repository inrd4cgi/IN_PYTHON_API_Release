...
namespace INS_INTERFACE
{
	...
	//获取职位列表,返回idNames
	extern "C" INSDRIVER_EXPORT qint32 GetJobList(QList<tag_CIdName>& idNames);
	...
	//返回说明：1==获取成功;0==获取失败。
	extern "C" INSDRIVER_EXPORT qint32 GetTeams(QList<TeamInfomation>& teams, const qint32& department_id = 0, qint32 projectId = 0);
