...
namespace INS_INTERFACE
{
	...
	INSDRIVER_EXPORT MessageInfo PostReviewContent(const INPostReviewParam &postReviewParam, INReviewTaskComment &reviewTaskComment);
	...
	INSDRIVER_EXPORT MessageInfo GetReviewContentByCommentId(QString &reviewComment, qint32 commentId);
};
