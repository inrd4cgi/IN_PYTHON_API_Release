...
namespace INS_INTERFACE
{
	...
	////获取文件服务器信息
	//INSDRIVER_EXPORT INQRespondInfo GetFileServerInfos(QList<INQServerInfo>& serverInfos);
	...
	INSDRIVER_EXPORT INQRespondInfo GetProjects(QList<INQProjectVO>& projects, INQGetPrjBusinessFilter prjFilter = INQGetPrjBusinessFilter());
