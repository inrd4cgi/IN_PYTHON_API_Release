...
namespace INS_INTERFACE
{
	...
	INSDRIVER_EXPORT INQRespondInfo GetTaskRelatedFiles(QMap<qint32, TaskFileVO>& taskFileVOs, qint32 taskId, FileTypeEnum fileType = FileTypeEnum::ALL);
	...
	//获取人员的会议列表 585
	INSDRIVER_EXPORT INQRespondInfo GetPannelViewList(QList<PanelReviewVO>& panelViews, int projectId = 0);
