...
# sys.path.append(r"D:\DEV\Github\IN_PYTHON_API_Release\src")
...
# files = in_api.listdir(folder_id=13030)
...
if _test_Get:
    ...
    resources = in_api.getTagResource(tag_name="TestTag")
...
if _test_Tag:
    ...
    # result = in_api.makeTag(tag_name="TestTag", resource_id=644, tag_object_id=TagObjectID.Asset)          # asset
    # result = in_api.makeTag(tag_name="TestTag", resource_id=2031, tag_object_id=TagObjectID.Workflow)      # task

    # result = in_api.removeTag(tag_name="cgfilm", resource_id=90, tag_object_id=TagObjectID.Folder)
    pass
...
if _test_Streaming:
    ...
    def testUploadCommentFile():
        path = r'D:\tutorial\Chrome\Chrome Extension Tutorial\1 - Introduction.mp4'
        task_id = 6478
